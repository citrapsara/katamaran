 ...
 */
//define ('PDF_HEADER_LOGO', 'jletter.png');
define ('PDF_HEADER_LOGO', 'kumham.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'KEMENTERIAN HUKUM DAN HAK ASASI MANUSIA');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "REPUBLIK INDONESIA\nKANTOR WILAYAH NUSA TENGGARA BARAT\nJalan Majapahit No. 44 Mataram\nTelepon : 0370 – 7856244\nLaman : ntb.kemenkumham.go.id, Surel : kanwilntb@kemenkumham.go.id");
